...
class RoleGroupMapperTest {
    ...
    void insert() {
        ...
        RoleGroup insertRoleGroup = RoleGroup.builder().roleGroupName(newRoleGroupName).roleGroupUse(newRoleGroupUse).companyNo(newCompanyNo).regUser("종현").build();
    ...
    void update() {
        ...
        RoleGroupUpdateDTO updateDTO = RoleGroupUpdateDTO.builder().roleGroupNo(updateRoleGroupNo).roleGroupName(updateRoleGroupName).roleGroupUse(updateRoleGroupUse).companyNo(2L).modUser("종현").build();
